...
//        if (!['Googlebot','Slurp','Twiceler', 'msnbot','KaloogaBot',
//             'YodaoBot','Baiduspider','googlebot','Speedy Spider','DotBot'].contains(request.getHeader("User-Agent"))){
//            postInstance.views = postInstance.views+1
//            postInstance.save()
//        }
